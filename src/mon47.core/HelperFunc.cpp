...
// ex) mailto:aaa@bbb.com?subject=����&body=�����Դϴ�.&cc=cc@example.com&bcc=bcc@example.com
...
ECODE ParseURL(std::tstring strURL, UrlData& outInfo)
{
	...
	{
		// �̽������� (%����, 0����) ����
		// ���û���: C905E41A8BCC21535DED384AFD6AF34C7DD48DB45D6584749F7A12F77D40A3DA
		//           c2ed9eb91d84f5b6114d34be06b6cabd.pdf
		strURL = DecodeUrlEncoding(strURL);

		// ũ���̳� ���� ���� �Ϻ� �������� �ڵ� ġȯ��
		// ���û���: FA7E1EDD021F78564B3E6FFD5F13D7AF1FE69A1891CC492BA84CCBD77E7F9E31
